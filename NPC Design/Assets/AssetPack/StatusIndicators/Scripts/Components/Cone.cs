...
namespace Werewolf.StatusIndicators.Components {
  public class Cone : SpellIndicator {
    ...
    private void SetAngle(float angle) {
      ...
      if(LBorder != null) LBorder.transform.localEulerAngles = new Vector3(0, 0, (angle + 2) / 2);
      if(RBorder != null) RBorder.transform.localEulerAngles = new Vector3(0, 0, (-angle + 2) / 2);
    }
